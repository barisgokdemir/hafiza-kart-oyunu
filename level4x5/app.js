...
function nextLevel() {
    window.location.href = "../level4x8/index.html";
}
...
var toplamrakam = randomDİzi(1, 10, 10).concat(randomDİzi(1, 10, 10));
...
var randwrite = randomDİzi(0, 20, 20);
...
document.querySelectorAll(".card").forEach((item) => {
    ...
    item.firstChild.setAttribute("src", "../Vangogh/vangogh" + toplamrakam[randwrite[control]] + ".jpg")
            ...
            if (controlclik < 3) {
                ...
                if (sayac % 2 == 0) {
                    if (temp == currentElement.dataset.value) {
                        ...
                        currentElement.setAttribute("style", "background-color:rgba(9, 190, 100, 0.7);visibility: hidden;");
                        tempElement.setAttribute("style", "background-color:rgba(9, 190, 100, 0.7);visibility: hidden;");
                        controlclik = 0;
                        trueCount++;
                        if (trueCount == 10) {
